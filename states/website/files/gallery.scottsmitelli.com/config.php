 ...
 */
$gallery->setConfig('setup.password', '{{ setup_password }}');
 ...
 */
$gallery->setConfig('data.gallery.base', '/var/opt/website/gallery.scottsmitelli.com/g2data/');
 ...
 */
$gallery->setConfig('baseUri', '{{ scheme }}://gallery.scottsmitelli.com/main.php');
?>
